...
test('properties', () => {
    ...
    expect((position1 as any).bitmask).toBeUndefined(); // Component "Position" was never registered.
    expect((position2 as any).bitmask).toBeUndefined(); // Component "Position" was never registered.
